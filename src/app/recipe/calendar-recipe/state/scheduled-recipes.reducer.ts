...
const scheduledRecipesReducer = createReducer(
  ...
  on(ScheduledRecipesActions.deleteScheduledRecipe,(state, { day, recipe }) => refreshListState(state, ScheduledRecipeService.deleteScheduledRecipe(state.scheduledRecipes, day, recipe)))
);
